...
class Communication {
    ...
    static final int INSTRUCTIONS_IDX = GameConstants.SHARED_ARRAY_LENGTH - 1;
    ...
    static void addInstructionCode(RobotController rc) {
        // instructions for newly created bot
    }
